...
const Cart = () => {
  ...
  const createOrder = async (data) => {
    try {
      const res = await axios.post("https://alex-pizza.vercel.app/api/orders", data);
      if (res.status === 201) {
    ...
    <div className={styles.container}>
      ...
      <div className={styles.right}>
        <div className={styles.wrapper}>
          ...
          <PayPalScriptProvider
            options={{
              "client-id": "ATonorL91SkTaR-3AkZj19aEuPbv-aYCnJPSZjN-dLB6wVnl2h9u5MJCz-ebDva_RN2FVZjejUC-Az_V",
              components: "buttons",
              currency: "USD",
